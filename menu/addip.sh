...
setadmin() {
#isi link git
linkinstall="https://raw.githubusercontent.com/kuhinh/ip/main"
rm -rf /etc/tarap/
mkdir -p /etc/tarap
...
git branch -M main
git remote add origin https://github.com/kuhing/ip.git
git push -f https://${tokengit}@github.com/kuhing/ip.git
